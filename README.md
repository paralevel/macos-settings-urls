...
<sup>_Disclaimer: This is a collection consisting exclusively of URLs I've found, or often pieced together, myself by examining local system files, and not built on, or meant to compete with, similar, already existing projects <sub>[1](https://gist.github.com/rmcdongit/f66ff91e0dad78d4d6346a75ded4b751)</sub>_</sup>
